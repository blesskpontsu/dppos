...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | ' . $this->lang->line('common_powered_by') . ' DPTek ' ?></title>
	...
	<?php else : ?>
		...
		<script type="text/javascript" src="dist/opensourcepos.min.js?rel=e58c6f7d2e"></script>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>">DP POS</a>
				</div>
